...
"\n"
"\"preferential_conditions_detail_header\": Refers to the name/title of each preferential condition within the financial product (e.g., '신규고객 우대', '급여이체 우대', '자동이체 우대'). Maximum 100 characters per item. Use empty array [] if no conditions.\n"
"\"preferential_conditions_detail_detail\": **CRITICAL FIELD** - Refers to the detailed explanation of HOW TO QUALIFY for each preferential condition within the financial product (e.g., '최초 가입 고객에게 적용', '월 50만원 이상 급여이체 시 적용', '3건 이상 자동이체 등록 시 적용'). **MUST be maximum 200 characters per item and in Korean.** This is a strict database constraint. Count characters before output. Use empty array [] if no conditions.\n"
"\"preferential_conditions_detail_interest_rate\": Refers to the additional interest rate (percentage points) added for each preferential condition within the financial product. **MUST be positive numbers only (> 0).** Cannot be 0 or negative values. If a condition doesn't provide additional interest rate, exclude it from all preferential arrays. Use empty array [] if no conditions provide additional rates.\n"
...
"\n"
"**ADDITIONAL CRITICAL RULES FOR PREFERENTIAL CONDITIONS:**\n"
"\n"
"**ONLY INCLUDE CONDITIONS THAT PROVIDE ADDITIONAL INTEREST RATES:**\n"
"- If a condition doesn't specify an additional interest rate (e.g., just eligibility criteria), DO NOT include it in the preferential arrays\n"
"- All conditions in the arrays must have positive interest rate values (> 0)\n"
"- Examples of conditions to EXCLUDE: basic eligibility requirements, minimum balance requirements without additional rates, general product features\n"
"\n"
"**EXAMPLES:**\n"
"✅ INCLUDE: \"신규고객 우대 연 0.5%p 추가\" → header: \"신규고객 우대\", detail: \"최초 가입 고객에게 적용\", rate: 0.5\n"
"✅ INCLUDE: \"급여이체 우대 연 0.3%p\" → header: \"급여이체 우대\", detail: \"월 50만원 이상 급여이체 시\", rate: 0.3\n"
"❌ EXCLUDE: \"최소 가입금액 100만원\" (no additional rate specified)\n"
"❌ EXCLUDE: \"만 19세 이상 가입 가능\" (basic eligibility, no rate bonus)\n"
"\n"
"**INTEREST RATE VALIDATION:**\n"
"- Before adding any condition to the arrays, confirm it has a positive additional interest rate\n"
"- If source says \"우대금리 최대 1.0%p\" but lists multiple conditions, only include conditions with specified individual rates\n"
"- When in doubt about whether a condition provides additional interest, exclude it from the arrays\n"
"\n"
...
"❌ FATAL ERROR: [[1,12]] ← THIS WILL ALSO BREAK THE APPLICATION\n"
...
"- [ ] **🚨 ULTRA CRITICAL: preferential_conditions_detail_interest_rate contains ONLY positive numbers (> 0)**\n"
"- [ ] **🚨 If any condition has no additional interest rate, exclude it from ALL preferential arrays**\n"
"\n"
...
"- preferential_conditions_detail_interest_rate contains 0 or negative values → Exclude those conditions\n"
"- Conditions with no specified additional interest rate → Exclude from ALL preferential arrays\n\n"
